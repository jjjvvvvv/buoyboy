...
with col1:
  st.subheader("SwH")
  st.markdown(
    "Swell height is the vertical distance (feet) between any swell crest and the succeeding swell wave trough."
  )

with col2:
  st.subheader("WvH")
  st.markdown(
    "Significant Wave Height is the average height (feet) of the highest one-third of the waves during a 20 minute sampling period."
  )
